document.addEventListener('DOMContentLoaded', () => {
  ...
  tl.fromTo('.bg-loader', 1.2, {width: '100%'}, {width: '0%', delay: 5, ease: Expo.easeInOut});
  tl.fromTo('.bg-video', 0.5, {width: '0%', opacity: 0}, {width: '100%', opacity: 1, ease: Expo.easeInOut}, '-=1');
  ...
  tl.fromTo('.item-5', 0.7, {y: -50, opacity: 0}, {y: 0, opacity: 1, ease: Expo.easeInOut}, '-=0.5');
});